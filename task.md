 Hi Candidate,
 Congratulations! You have been shortlisted from the initial screening round for the position of Dev Ops Engineer Intern
As part of the next step in the hiring process, we’d like you to complete the following technical assignment. This task is designed to evaluate your hands-on skills with containerization, CI/CD, and cloud deployment. Kindly submit your assignment by 6PM tomorrow (28th Nov 2025) end of day (EOD).
...
📦 Deliverables
Please share the GitHub repository link once you’ve completed the task. Make sure your repository includes:
